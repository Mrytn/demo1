...
public class StringUtils {
	 ...
	 * StringUtils.isNumeric("12-3") = false
	 * StringUtils.isNumeric("12.3") = false
	 * StringUtils.isNumeric("-12") = false
	 * </pre>
	 *
	 * @param str
	 *            the String to check, may be null
	...
	/**
	 * 更新地址：http://www.cnblogs.com/zengxiangzhan/p/phone.html
	 * 【三大运营商最新号段 合作版】
	 * 移动号段： 134,135,136,137,138,139,147(上网卡),150,151,152,157,158,159,1703,1705,1706,172,178,182,183,184,187,188,198,148,1440
	 * 电信号段： 133,153,149,1349（卫星通信）,1700,1701,1702,173,177,180,181,189,199,1410,191
	 * 联通号段： 130,131,132,145,155,156,1704,1707,1708,1709,171,175,176,185,186,166,146,167
	 */
	...
	public static boolean isMobileExt(String str) {
		if (isNumeric(str) && (str.length() == 11 || (str.length() == 13 && str.startsWith("86")))) {
			return true;
		}
		return false;
	}
	...
	/**
	 * 是否是合法的密码
	 * 2017/11/27 修改密码验证为英文，特殊字符和数字组合，长度为6到20位的正则验证
	 */
	public static boolean isPassword(String newPass) {
		String ip = "^(?![0-9]*$)(?![a-zA-Z]*$)[\\x00-\\xFF]{6,20}$";
	 ...
	 * 获取split[0]
	 */
	public static String getSplitHead(String str, String flag) {
	...
	public static String getKey(String key1 , String key2) {
		return makeKey(SPLITSIGN,key1,key2);
	}
	 ...
	 * @return
	 */
	public static String makeKey(String splitTag, Object... key) {
		if(key.length == 0){
			return "";
		}
		if(key.length == 1){
	 ...
	 * @return
	 */
	public static List<String> tags2List(String string,String splitTag) {
		if(string == null){
			return null;
		}
		...
		String[] lineObj = string.split(splitTag);
		for (String tag : lineObj){
			tag = tag.trim();
			if(tag.length()>0){
				result.add(tag);
			}
	...
	public static List<String> tags2List(String string) {
		return tags2List(string,SPLITSIGN);
	}
	/*
